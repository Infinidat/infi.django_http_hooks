# -*- coding: utf-8 -*-
# Generated by Django 1.11.3 on 2018-06-29 12:11
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('headers', models.TextField(blank=True, null=True)),
                ('payload_template', models.TextField(blank=True, help_text='Use {{}} for variables template. Placeholder names can be any attribute in the model. Leave empty for default payload. See documentation for further details.  ', null=True)),
